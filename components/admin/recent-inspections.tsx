...
const recentInspections: Inspection[] = [
  {
    id: "1",
    machine: "777 Truck #156",
    operator: "James Lee",
    status: "PASS",
    timestamp: "2026-02-27 14:32",
    findings: "All systems operational. Minor wear on tracks noted.",
  },
  {
    id: "2",
    machine: "320 Excavator #1138",
    operator: "Sarah Chen",
    status: "MONITOR",
    timestamp: "2026-02-27 11:15",
    findings: "Hydraulic pressure slightly below optimal. Schedule maintenance.",
  },
  {
    id: "3",
    machine: "D6 Dozer #472",
    operator: "Mike Johnson",
    status: "PASS",
    timestamp: "2026-02-26 16:45",
    findings: "Engine running smoothly. Fluid levels nominal.",
  },
  {
    id: "4",
    machine: "140 Grader #234",
    operator: "Tom Wilson",
    status: "FAIL",
    timestamp: "2026-02-24 09:20",
    findings: "Brake system requires immediate attention. Do not operate.",
  },
  {
    id: "5",
    machine: "CS56 Compactor #89",
    operator: "Anna Park",
    status: "MONITOR",
    timestamp: "2026-02-23 13:50",
    findings: "Vibration system intermittent. Needs diagnostic check.",
  },
];
  ...
  return (
    <div className="bg-[#2a2a2a] rounded-2xl border border-white/5 overflow-hidden">
      ...
      <div className="p-4 border-b border-white/5 flex items-center justify-between">
        ...
        <button className="text-cat-yellow text-sm font-medium hover:underline">
          View All
        </button>
      </div>
